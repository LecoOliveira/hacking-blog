export default function Privacy() {
  return (
    <div
      className="w-11/12 sm:w-[600px] md:w-[800px] m-auto 
    ...
    >
      ...
      <p className="leading-7">
        <span>
          A sua privacidade é importante para nós. É política do Hacking BLOG
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site
          <a href="https://hackingblog.online">Hacking BLOG</a>, e outros sites
      ...
      <p className="leading-7 mt-4">
        <span>
          ...
          informação que o Hacking BLOG oferece no site e com caráter
      ...
      <ul className="leading-7 mt-4">
        ...
        <li>
          <span>
            ...
            (softwares) do Hacking BLOG, de seus fornecedores ou terceiros, para
